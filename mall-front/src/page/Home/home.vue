      ...
      <div class="bg" ref="bg"
        ...
        <transition name="fade">
          <div v-for="(item, i) in banner" v-if="i===mark" :key="i" style="position:absolute" @click="linkTo(item)" @mouseover="stopTimer" @mouseout="startTimer">
            <img v-if="item.picUrl" class="img1" :src="'http://192.168.100.102/'+item.picUrl"/>
            <img v-if="item.picUrl2"  class="img2 a" :src="'http://192.168.100.102/'+item.picUrl2"/>
            <img v-if="item.picUrl3"  class="img3 b" :src="'http://192.168.100.102/'+item.picUrl3"/>
          </div>
        </transition>
      </div>
      <div class="page">
