...
import com.athenan.demo.exception.RocketMQErrorEnum;
import com.athenan.demo.exception.RocketMQException;
...
public class MQConsumerConfiguration {
    ...
    @Bean
    public DefaultMQPushConsumer getRoccketMQConsumer() throws RocketMQException {
        if(StringUtils.isEmpty(groupName)){
            throw new RocketMQException(RocketMQErrorEnum.PARAME_NULL,"groupNmae is null!!!",false);
        }
        if (StringUtils.isEmpty(namesrvAddr)){
            throw new RocketMQException(RocketMQErrorEnum.PARAME_NULL,"namesrvAddr is null !!!",false);
        }
        if(StringUtils.isEmpty(topics)){
            throw new RocketMQException(RocketMQErrorEnum.PARAME_NULL,"topics is null !!!",false);
        }
