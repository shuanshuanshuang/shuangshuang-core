...
import com.dongnaoedu.mall.manager.dto.ChartData;
...
public class CountController {
	...
	public Result<Object> countOrder(@RequestParam int type, @RequestParam(required = false) String startTime,
			@RequestParam(required = false) String endTime, @RequestParam(required = false) int year) {
