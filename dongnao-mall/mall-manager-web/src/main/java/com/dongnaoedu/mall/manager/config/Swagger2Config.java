...
/**
 * @see https://www.vojtechruzicka.com/documenting-spring-boot-rest-api-swagger-springfox/
 * @author allen
 */
...
public class Swagger2Config {
	...
	public Docket createRestApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				// 扫描指定包中的swagger注解
				// .apis(RequestHandlerSelectors.basePackage("com.dongnaoedu.mall.manager.controller"))
