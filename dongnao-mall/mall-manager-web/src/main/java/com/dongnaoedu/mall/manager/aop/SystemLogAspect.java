package com.dongnaoedu.mall.manager.aop;
...
import com.dongnaoedu.mall.common.annotation.SystemControllerLog;
import com.dongnaoedu.mall.common.annotation.SystemServiceLog;
import com.dongnaoedu.mall.common.utils.IPInfoUtil;
import com.dongnaoedu.mall.common.utils.ThreadPoolUtil;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.dongnaoedu.mall.common.annotation.SystemControllerLog)")
	 ...
	 */
	@Pointcut("@annotation(com.dongnaoedu.mall.common.annotation.SystemServiceLog)")
	...
	public void after(JoinPoint joinPoint) {
		try {
			...
			if (null != username) {
				...
				// IP地址
				tbLog.setIpInfo(IPInfoUtil.getIpCity(IPInfoUtil.getIpAddr(request)) != null ? IPInfoUtil.getIpCity(IPInfoUtil.getIpAddr(request)) :"");
				// 请求开始时间
