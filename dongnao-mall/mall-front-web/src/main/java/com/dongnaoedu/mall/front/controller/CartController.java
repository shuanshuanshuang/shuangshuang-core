...
import com.dongnaoedu.mall.manager.dto.front.Cart;
import com.dongnaoedu.mall.manager.dto.front.CartProduct;
import com.dongnaoedu.mall.sso.service.CartService;
...
public class CartController {
	...
	public Result<Object> updateCartNum(@RequestBody Cart cart) {
		...
		int result = cartService.updateCartNum(cart.getUserId(), cart.getProductId(), cart.getProductNum(),
				cart.getChecked());
		return new ResultUtil<Object>().setData(result);
	}
